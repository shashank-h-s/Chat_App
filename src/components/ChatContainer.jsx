...
const ChatContainer = ({ selectedUser, setSelectedUser }) => {
  return selectedUser ? (
    <div className="h-full overflow-scroll relateive backdrop-blur-lg">
      {/* -------header------- */}
        ...
        {messagesDummyData.map((msg, index) => {
          ...
          >
            {msg.image ? (
              ...
              <p
                className={`p-2 max-w-[200px] md:text-sm font-light rounder-lg mb-8 break-all bg-violet-500/30 text-white ${msg.senderId !== "680f50e4f10f3cd28382ecf9"
                  ? "rounded-br-none"
                  : "rounded-bl-none"
                  }`}
              >
